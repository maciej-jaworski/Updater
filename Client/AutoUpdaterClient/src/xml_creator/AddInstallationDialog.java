...
public class AddInstallationDialog extends Dialog {
	 ...
	 * @param style
	 */
	public AddInstallationDialog(Shell parent, String temp_EH,
	...
	private void createContents() {
		...
		shell.setImage(SWTResourceManager.getImage(AddInstallationDialog.class,
		...
		btnInstall.setImage(SWTResourceManager.getImage(
				AddInstallationDialog.class, "/images/xc_dir.png"));
